...
export async function sendContactEmail(formData: FormData) {
  try {
    ...
    const mailOptions = {
      ...
      to: "contato@jordanhatargino.adv.br",
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px;">
            ...
            <p>Recebemos sua consulta sobre <strong>${benefitType || "benefícios previdenciários"}</strong> e agradecemos pelo contato.</p>
            ...
            <p>Caso tenha urgência, entre em contato pelo WhatsApp: <strong>(11) 99999-9999</strong></p>
          ...
          <div style="background: #F8F6F0; padding: 20px; text-align: center; font-size: 12px; color: #666;">
            <p>Este é um email automático. Para dúvidas, responda este email ou ligue para (11) 99999-9999</p>
          </div>
        </div>
      `,
    }
